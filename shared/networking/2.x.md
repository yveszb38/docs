...
At the time of writing we have tested a number of GSM modems with {{ $names.os.lower }} 2.0, in general most of the modems listed in the [**ModemManager** Supported Devices list][modemmanager-supported-devices] should work out of the box with {{ $names.company.lower }}, but below is a list of ones that have been tested and known to work.
...
__Note:__ If your are powering your USB modem from a Raspberry Pi, it is a good idea to enable the full 1.2A current throughput for the USB ports, you can see how to do this [here](https://docs.{{ $names.domain }}/hardware/i2c-and-spi/#increase-usb-current-throughput-)
