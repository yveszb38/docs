...
Once you have finished your image configuration, click the *Download {{ $names.os.lower }}* button. When the download completes, you should have a zipped image file with a name like `resin-FirstApp-2.3.0+rev1-dev-v6.1.3.img.zip`, where `FirstApp` is the name you gave your application on the dashboard.
