...
`resin-data` is the partition that holds downloaded Docker images. Generally any container data will be found here. If you want to read a bit more about the partition layout, have a look at the [{{ $names.os.lower }} github repo](https://github.com/resin-os/meta-resin/blob/master/meta-resin-common/classes/image_types_resin.bbclass#L20).
...
|-----------------------------------|-------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| meta-resin                        | https://github.com/resin-os/meta-resin                                        | This repository enables building {{ $names.os.lower }} for various devices                         |
| meta-resin-jethro                 | https://github.com/resin-os/meta-resin                                        | This layer enables building {{ $names.os.lower }} for jethro supported BSPs                        |
| meta-resin-raspberrypi            | https://github.com/resin-os/resin-raspberrypi                                 | Enables building {{ $names.os.lower }} for chosen meta-raspberrypi machines.                        |
